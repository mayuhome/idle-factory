...
export default function IdleFactoryGame() {
  ...
  const [availableGoods, setAvailableGoods] = useState<Good[]>(initialGoods.filter((g) => !g.researchId)) // Goods not requiring research
        ...
        >
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 bg-black/10">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle>
                  {factory.name} {factory.isLocked && <Lock className="inline w-5 h-5 ml-2 text-red-400" />}
                </CardTitle>
                <CardDescription>
